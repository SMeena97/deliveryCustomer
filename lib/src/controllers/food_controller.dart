...
class FoodController extends ControllerMVC {
  ...
  FoodController() {
   ...
   void listenForFood({String foodId, String message,String restaurantId}) async {
     print('ded'+foodId+" "+restaurantId.toString());
 
    final Stream<Food> stream = await getFood(foodId,restaurantId);
