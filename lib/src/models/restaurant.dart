...
class Restaurant {
  ...
  Restaurant.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      id = jsonMap['pickup_point_id'];
      name = jsonMap['pickup_point_name'];
      image = jsonMap['image'];
      ...
      address = jsonMap['pickup_point_address'];
      description = jsonMap['description'];
      phone = jsonMap['pickup_point_contact'];
      mobile = jsonMap['mobile'];
      defaultTax = jsonMap['default_tax'] != null ? jsonMap['default_tax'].toDouble() : 0.0;
      information = jsonMap['pickup_point_Desc'];
      promoCode = jsonMap['couponcode'];
      latitude = jsonMap['pickup_point_lat'];
      longitude = jsonMap['pickup_point_lang'];
