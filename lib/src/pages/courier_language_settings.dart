...
class CourierLanguagesWidget extends StatefulWidget {
  @override
  _CourierLanguagesWidgetState createState() => _CourierLanguagesWidgetState();
}

class _CourierLanguagesWidgetState extends State<CourierLanguagesWidget> {
            ...
            Container( 
              margin: EdgeInsets.symmetric(horizontal:20,vertical:20),
                child:GestureDetector( 
                  onTap: _logoutActivitity,
                  child:Row(children: [ 
                   Icon(Icons.exit_to_app),
                   SizedBox(width:10),
                   Text( S.of(context).log_out,style:TextStyle(fontSize: 16))
                  ],)
                )
