...
class _RestaurantWidgetState extends StateMVC<RestaurantWidget> {
  ...
  int calculateDistance(lat2, lon2) {
    double distanceInMeters =
        Geolocator.distanceBetween(lat1, lng1, lat2, lon2);
  ...
  _getStore() async {
    ...
    setState(() {
      lat1 = prefs.getDouble("deliverylat");
      lng1 = prefs.getDouble("deliverylng");
    });
  }
  ...
  void initState() {
    ...
    print("resId" + _con.restaurant.id);
                        ...
                        SliverToBoxAdapter(
                          child: Wrap(
                            children: [
                              ...
                              _con.restaurant.promoCode != null
                                  ? Container(
                                      padding: const EdgeInsets.symmetric(
