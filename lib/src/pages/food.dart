...
class _FoodWidgetState extends StateMVC<FoodWidget> {
  FoodController _con;
  final snackBar = SnackBar(content: Text('Clear existing cart'));
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: SingleChildScrollView(
          child: ListBody(
            children: <Widget>[
              Text('You are adding item in another resturant.'),
              Text('Please do empty your cart to add this item'),
            ],
          ),
        ),
        actions: <Widget>[
  ...
  @override
  void initState() {
  _con.listenForFood(foodId: widget.routeArgument.id,restaurantId:widget.routeArgument.restaurantId );
                                    ...
                                    SizedBox(
                                      ...
                                      child: FlatButton(
                                        onPressed: () {
                                          ...
                                          if (!currentUser.value.auth) {
                                            Navigator.of(context).pushNamed("/Login");
                                          } else if (_con.isSameRestaurants(_con.food)) {
