...
class LanguageSettingsWidget extends StatefulWidget {
  @override
  _LanguageSettingsStateWidget createState() => _LanguageSettingsStateWidget();
}

class _LanguageSettingsStateWidget extends State<LanguageSettingsWidget> {
            ...
            Container(
              ...
              child: RaisedButton(
                onPressed: () async {
                  ...
                  prefs.setString("language_selected", "selected");
