...
class Helper {
  ...
  static getData(Map<String, dynamic> data) {
   ...
   static getBaseData(Map<String, dynamic> data) {
    return data['result'] ?? [];
  }

  static int getIntData(Map<String, dynamic> data) {
    return (data['result'] as int) ?? 0;
  }

  static double getDoubleData(Map<String, dynamic> data) {
    return (data['result'] as double) ?? 0;
  }
  ...
  static getObjectData(Map<String, dynamic> data) {
    return data['result'] ?? new Map<String, dynamic>();
  }
...
//        },
  ...
  static Uri getUri(String path) {
    String _path = Uri.parse(GlobalConfiguration().getValue('local_url')).path;
    if (!_path.endsWith('/')) {
      _path += '/';
    }
    Uri uri = Uri(
        scheme: Uri.parse(GlobalConfiguration().getValue('local_url')).scheme,
        host: Uri.parse(GlobalConfiguration().getValue('local_url')).host,
        port: Uri.parse(GlobalConfiguration().getValue('local_url')).port,
        path: _path + path);
    return uri;
  }

    static Uri getBaseUri(String path) {
