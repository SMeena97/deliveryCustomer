...
import '../repository/user_repository.dart' as userRepo;
 ...
 Future<MyOrder> getMyOrders() async {
    User _user = userRepo.currentUser.value;
     final String url =
     '${GlobalConfiguration().getValue('local_url')}Orders/loadAppUserOrders?app_user_id=${_user.id}';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        celebritiesModel = MyOrder.fromJson(jsonMap);
      }
    } catch (Exception) {
