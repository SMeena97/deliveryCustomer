  ...
  Widget build(BuildContext context) {
    return Dismissible(
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.of(context).pushNamed('/Food', arguments: RouteArgument(id: widget.cart.food.id, heroTag: widget.heroTag,restaurantId:widget.cart.food.restaurant.id ));
        },
        child: Container(
