...
class FoodsCarouselItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        Navigator.of(context).pushNamed('/Food', arguments: RouteArgument(id: food.id, heroTag: heroTag,restaurantId:food.restaurant.id ));
      },
      child: Column(
          ...
          Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Text(
                    food.restaurant.name ?? 'default restaurant name',
                    overflow: TextOverflow.fade,
                    softWrap: false,
