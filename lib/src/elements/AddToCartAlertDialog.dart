                ...
                children: <Widget>[
                  Hero(
                    ...
                    child: Container(
                      ...
                      //   image: DecorationImage(image: NetworkImage(this.newFood?.restaurant?.image), fit: BoxFit.cover),
                      // ),
                    ),
                  ),
                  SizedBox(width: 15),
                ...
                children: <Widget>[
                  Hero(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.all(Radius.circular(5)),
                        image: DecorationImage(image: NetworkImage(this.oldFood.restaurant.image), fit: BoxFit.cover),
                      ),
                    ),
                  ),
                  SizedBox(width: 15),
