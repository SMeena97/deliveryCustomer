...
class _FoodGridItemWidgetState extends State<FoodGridItemWidget> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        Navigator.of(context).pushNamed('/Food', arguments: new RouteArgument(heroTag: this.widget.heroTag, id: this.widget.food.id,restaurantId:this.widget.food.restaurant.id ));
      },
      child: Stack(
                ...
                child: Hero(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(image: NetworkImage(this.widget.food.image), fit: BoxFit.cover),
