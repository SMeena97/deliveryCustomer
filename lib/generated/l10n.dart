...
class S {
  ...
  /// `Send the package anywhere and anytime`
  String get send_anywhere {
    return Intl.message(
      'Send the package anywhere and anytime',
      name: 'send_anywhere',
      desc: '',
  ...
  /// `Order what you want now and it will be delivered to you as soon as possible`
  String get order_delivery {
    return Intl.message(
      'Order what you want now and it will be delivered to you as soon as possible',
      name: 'order_delivery',
      desc: '',
